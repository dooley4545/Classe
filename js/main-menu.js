...
function classtabs(){
    var i=0;
    $('.classes .tab-pane').each(function(){
        i++
        var newID='class'+i;
        $(this).attr('id',newID);
        $(this).val(i);
...
function eventsDisplay(){
    $('.events-list .simcal-day-label').wrap("<div class='col-md-3'></div>");
    $('.events-list .simcal-day').wrap("<div class='col-md-9'></div>");
    $('.events-list .simcal-day ul li').addClass("col-md-4");
}
